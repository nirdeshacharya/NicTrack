...
public class NicTracContext : DbContext
{
    ...
    public DbSet<Cravings> Cravings { get; set; }
    public DbSet<Goal> Goals { get; set; }
    public DbSet<Intake> Intakes { get; set; }
    public DbSet<Location> Locations { get; set; }
    public DbSet<NicotineHistory> NicotineHistories { get; set; }
    public DbSet<NicotineType> NicotineTypes { get; set; }
    public DbSet<PersonalHealthStatus> PersonalHealthStatuses { get; set; }
